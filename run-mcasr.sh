...
# tweaked from run.sh to read for each short mp3 clip,
# instead of several English-letter transcriptions,
# several mcasr/s5c/data/LANGUAGE/lang/phones.txt phone-string transcriptions.
#
